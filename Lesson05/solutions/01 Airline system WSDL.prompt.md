### Airline system
Write code in the .NET and SoapCore when applicable that generates a WSDL document that implements the `SearchFlights` operation for an airline system with the following requirements:
